(function () {
  ...
  const loadAssistant = async () => {
    try {
      const res = await fetch(`https://shifra-ai-lqhq.onrender.com/api/assistant/config/${userId}`)
    ...
    recognition.onresult = (e) => {
      ...
      setTimeout(async () => {
        try {
          ...
          const res = await fetch("https://shifra-ai-lqhq.onrender.com/api/assistant/ask", {
            method: "POST",
            headers: {
